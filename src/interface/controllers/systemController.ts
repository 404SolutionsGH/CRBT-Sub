...
import { getSystemInfo } from "../../useCases/admin/getSystemInfo";
...
export const systemInfoController = asyncHandler(async (req: Request, res: Response) => {
  res.status(200).json({systemInfo: await getSystemInfo()})
});
